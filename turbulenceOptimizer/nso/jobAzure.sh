...
/shared/home/azureuser/lib/openfoam/mto/ThirdParty-6/platforms/linux64Gcc/openmpi-1.10.7/bin/mpirun -np ${SLURM_NTASKS:-$NPROCS} MTO_Turbulence -parallel > runLOG
